            ...
            <div className='section max-w-full       '>
                ...
                <div className='content max-w-7xl pt-4 px-8  m-auto flex pb-8  '>
                    ...
                    <div className='left-content flex-col text-left  w-3/5 pt-10 items-start text-sky-500 flex-row'>
                        {/* top link */}
                        <a href="" className='link font-semibold mb-2 text-2xl max-w-xl leading-loose mt-10'>   Jump Start you portfolio   </a>
                        {/* left heading */}
                        <h1 className='headingOne flex pb-10 flex-row  text-5xl text-black font-bold max-w-xl'>Jump Start your crypto portfolio</h1>
                        <h3 className='headingthree font-semibold text-2xl text-black ' >coinbase is a app where you can earn huge profit </h3>
                        <div className='Email flex items-center flex-row max-w-xl mt-8'>
                            {/* input email   */}
                            <div className='inputfields'>
                                <form className='form flex flex-row w-full'>
                                    <div className='input flex flex-row relative '>
                                        <input type="email" placeholder='Enter Email' name='email' className='inputarea h-12 rounded-md text-black' required>
                                        </input>
                                    </div>
                                    {/* click button left side  */}
                                    <div className='button'>
                                      <button className='submit relative w-40 ml-3 h-full   text-white rounded-md bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500'  >Get Started</button> 
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div className='right-content flex  pt-8 pl-5   w-3/5 pt-10'>
                        {/* mobile image  */}
                        <img src={img} className='image rounded-3xl '></img>
                    </div>
                ...
                {/* <section className='middlePortion flex   max-w-full m-auto p-4 w-full '>
                    ...
                    <div className='middlePartCurency flex m-auto flex-row justify-center  w-full  '>
                        ...
                        <p className='middlePara   w-full text-3xl mt-6 '>Cuko has best place in the market </p>
                        ...
                        <div className='reasonHeading   items-center   text-center  max-w-full'>
                            ...
                            <div className='reasonsitems  flex  flex-row justify-center w-full mt-8 '>
                                <div className='r-item m-4 items-center w-full'>  <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" style={{ margin: "auto" }} fill="#fb8c00" class="bi bi-shield-lock-fill" viewBox="0 0 16 16">
                                    ...
                                    <p className='securePara mt-3 leading-8 text-xl '>We have complete privacy of your data</p>
                                    {/* for space  */}
                                    <section className='spaceSectioin flex w-full pt-10 m-auto shrink-0 '>
                                        <div className='spaceDiv flex grow flex-row'></div>
                                    </section>
                                    <button className='LearnMore mt-6 text-3xl leading-8 font-medium text-blue-700   font-serif rounded-full  '>Learn More   </button>
                                </div>
                                ...
                                <div className='r-item   w-full   '>
                                    <div className='insideItemsSecurity m-4'>
                                        ...
                                        <h2 className='bestPractice mt-5 text-3xl leading-8 font-semibold '>Industry best practice</h2>
                                        <p className='bestPracticePara mt-3 leading-8 text-xl'>Cuko support various sort's of online business  </p>
                                        {/* for space  */}
                                        <section className='spaceSectioin flex w-full pt-10 m-auto shrink-0 '>
                                            <div className='spaceDiv flex grow flex-row'></div>
                                        </section>
                    ...
                    <section className='bannerclass flex  max-w-6xl w-full m-auto  '>
                        <div className='bannerItemsInside w-full flex flex-row    m-auto '>
                            <div className='insideBitems w-1/3   '>
                                <div className='bannerPrice mt-8 leading-8 text-4xl text-zinc-100    '>$10,00,000</div>
                                <div className='bannerDesc mt-8 leading-8 text-2xl text-zinc-100'>Amout Generated</div>
                            </div>
                            <div className='insideBitems  w-1/3 '>
                                <div className='bannerPrice mt-8 leading-8 text-4xl text-zinc-100    '>100+</div>
                                <div className='bannerDesc mt-8 leading-8 text-2xl text-zinc-100'>Countries Supported</div>
                            </div>
                            <div className='insideBitems  w-1/3 '>
                                <div className='bannerPrice mt-8 leading-8 text-4xl text-zinc-100    '>4.5+ Cr</div>
                                <div className='bannerDesc mt-8 leading-8 text-2xl text-zinc-100'>Verified User's</div>
                            </div>
                        </div>
                ...
                <section className='addditonal flex w-full m-auto p-2'>
                    <div className='additionalInsiide flex flex-col items-center w-full'>
                        {/* headings  */}
                        <h2 className='additionalHeading mt-4 text-5xl  font-semibold leading-8 w-full'>Get started in few minutes</h2>
                        <h2 className='additonalHeadingLower mt-8 text-2xl    leading-8 w-full'>Cuko have various scope of earning</h2>
